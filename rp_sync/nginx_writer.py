...
_SSL_HEADER = """\
# Generated by rp-sync — do not edit manually
...
class NginxConfigWriter:
    ...
    def write(
        ...
        content = self._generate(services, profiles, default_profile)
        tmp = self.cfg.conf_path + ".tmp"
        with open(tmp, "w", encoding="utf-8") as f:
            f.write(content)
        os.replace(tmp, self.cfg.conf_path)
